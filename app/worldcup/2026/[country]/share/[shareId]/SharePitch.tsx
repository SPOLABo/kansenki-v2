  ...
  return (
    <div className="mt-4">
      <div className="px-1 pb-4">
        <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden bg-gradient-to-b from-green-400/75 via-emerald-500/70 to-emerald-900/60 border border-white/10">
          <div
