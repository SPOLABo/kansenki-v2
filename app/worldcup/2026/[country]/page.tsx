...
import { WC2026_CANDIDATES_BY_COUNTRY, type Wc2026Candidate } from '@/lib/worldcup/wc2026Candidates';
...
export default function Wc2026CountryPage() {
  ...
  const candidates = useMemo(() => {
    if (!country) return [];
    return (WC2026_CANDIDATES_BY_COUNTRY as Record<string, Wc2026Candidate[]>)[country.code] ?? [];
  }, [country]);

  const candidatesByPos = useMemo(() => {
    const out: Record<SquadPosition, Wc2026Candidate[]> = { GK: [], DF: [], MF: [], FW: [] };
