...
export default function BottomTabBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-[9999] pointer-events-auto touch-manipulation border-t border-white/10 bg-slate-950/90 sm:bg-slate-950/80 sm:backdrop-blur">
      <div
        className="mx-auto grid max-w-xl px-2 pt-2 pb-[calc(env(safe-area-inset-bottom)+0.75rem)]"
          ...
          return (
            t.external ? (
              <a
                ...
                className={
                  `flex w-full select-none flex-col items-center justify-center gap-1 rounded-xl px-2 py-3 transition-colors pointer-events-auto ` +
