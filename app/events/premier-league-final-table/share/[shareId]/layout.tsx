...
export async function generateMetadata({ params }: Props, _parent: ResolvingMetadata): Promise<Metadata> {
  ...
  if (!db) {
    return {
      title: fallbackTitle,
      openGraph: { title: fallbackTitle, images: [{ url: fallbackImageUrl, width: 1200, height: 630 }], url: pageUrl },
      twitter: { card: 'summary_large_image', title: fallbackTitle, images: [fallbackImageUrl] },
    };
  }
  ...
  try {
    ...
    const imageUrl = storedOg ?? fallbackImageUrl;
